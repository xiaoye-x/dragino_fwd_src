...
define Package/$(PKG_NAME)/install
	...
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/build_station_sx1301/build-mips-openwrt-dragino/bin/station_sx1301 $(1)/usr/bin
	$(INSTALL_BIN) $(PKG_BUILD_DIR)/station/bin/rinit.sh $(1)/usr/bin
